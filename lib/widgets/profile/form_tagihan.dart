...
class _ProductFormState extends State<ProductForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      // dort billPayments by createdAt ascending
                        ...
                        child: Column(
                          children: [
                              ...
                              children: [
                                Text(
                                  DateFormat('dd-MM-yyyy HH:mm')
                                      .format(billPayments[0].createdAt!),
                                  style: const TextStyle(
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  Format.formatRupiah(billPayments[0].total),
                                  style: const TextStyle(
                                      color: Color(0xFF91E0DD),
                                      fontSize: 14,
                                      fontWeight: FontWeight.bold,
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: billPayments[0].status == 'confirmed'
                                        ? const Color(0xFF91E0DD)
                                        : billPayments[0].status == 'waiting'
                                            ? const Color(0xFF69A9F4)
                                            : const Color(0xFFF46B69),
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                  child: Text(
                                    billPayments[0].status == 'confirmed'
                                        ? 'Lunas'
                                        : billPayments[0].status == 'waiting'
                                            ? 'Menunggu Konfirmasi'
                                            : 'Ditolak',
                ...
                if (bill.total > 0) ...[
                  Column(
                    children: [
                      ...
                      // const SizedBox(height: 10),
                      Obx(() {
                        final paymentMethods = getAdminPaymentMethodsController
                            .adminPaymentMethods;
